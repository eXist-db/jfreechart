...
public interface Renderer {
     ...
     */
    void render(JFreeChart chart, Configuration config, OutputStream os) throws IOException;
     ...
     * @throws IOException Thrown when something bad happens
     */
    byte[] render(JFreeChart chart, Configuration config) throws IOException;
